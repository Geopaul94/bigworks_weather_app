...
class _WeatherHomePageState extends State<WeatherHomePage> {
 ...
 void setday() async {
  if (weather.date != null && weather.date.isNotEmpty) {
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      physics: BouncingScrollPhysics(),
                    itemCount: (weather.forecast.length > hour) ? weather.forecast.length - hour - 1 : 0,
                      ...
                      itemBuilder: (context, index) => SingleChildScrollView(
                        ...
                        child: Center(
                            ...
                            //         .replaceAll('//', 'http://'))
                     child:       ForecastCard(
  hour: weather.forecast.isNotEmpty ? weather.forecast[hour + index]['time'].toString().split(' ')[1] : '',
  averageTemp: weather.forecast.isNotEmpty ? weather.forecast[hour + index]['temp_c'] : 0,
  description: weather.forecast.isNotEmpty ? weather.forecast[hour + index]['condition']['text'] : '',
  descriptionIMG: weather.forecast.isNotEmpty
      ? weather.forecast[hour + index]['condition']['icon'].toString().replaceAll('//', 'http://')
      : '',
),
